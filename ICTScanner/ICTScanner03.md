Distinguer visuellement un **Order Block (Support dur)** d'un **Fair Value Gap (Vide de liquidité)** permet de prendre des décisions plus rapides.

Voici la **Version 1.40**.

### Ce qui change :
1.  J'ai remplacé les 2 anciennes couleurs par **4 couleurs distinctes** dans les paramètres.
2.  Par défaut :
    *   **Order Blocks (OB)** = **Bleu** (Achat) et **Rouge Foncé** (Vente).
    *   **Fair Value Gaps (FVG)** = **Vert Clair** (Achat) et **Rose/Saumon** (Vente).
3.  Le code de dessin a été adapté pour appliquer la bonne couleur selon le pattern détecté.

Copiez l'intégralité du code ci-dessous :

### Code Scanner SMC - Couleurs Distinctes (v1.40)
