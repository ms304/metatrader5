...
// --- Paramètres ICT/SMC ---
input int      SwingLookback      = 18;//10;     // Bougies pour détecter swing H/L
input int      OB_Lookback        = 25;//20;     // Bougies lookback pour Order Blocks
input int      FVG_MinPoints      = 150;//5;      // Taille minimale FVG (en points)
