...
input string API_KEY = "L'Ile de La Réunion est la plus belle Ile du monde !";
...
void LogResponse(string response)
{
   ...
   if(fileHandle != INVALID_HANDLE)
   {
      ...
      MqlDateTime dt;
      TimeCurrent(dt);
      string logEntry = StringFormat("%04d.%02d.%02d %02d:%02d:%02d - Reponse Gemini: %s\r\n", 
...
void CallGemini()
{
   ...
   // --- LOG DE LA REPONSE AVEC DATE ET HEURE ---
   LogResponse(out);
