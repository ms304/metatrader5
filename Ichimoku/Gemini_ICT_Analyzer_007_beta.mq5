...
input string API_KEY = "Manz Un Bon Rougail La Morue Ke Lé Fé Par Ma Tatie Ginette !!";
...
void CallGemini()
{
   ...
   // Extraire le texte de la réponse (sans le JSON)
   string finalResponse = ExtractSignal(out);
   
   // --- LOG DE LA RÉPONSE COMPLÈTE ---
   LogResponse(finalResponse);
   
   // Affichage dans le terminal (version courte pour ne pas polluer)
   Print("========================================");
