...
#property version   "4.65_Persistent_Millionnaire_Version"
#property strict
...
input bool     InpUseTenkan      = true;   // Activer détection Tenkan
input bool     InpUseKijun       = true;   // Activer détection Kijun
input bool     InpUseSSB         = true;   // Activer détection SSB (Senkou Span B)
...
void OnTimer() {
   ...
   for(int i = g_currentIdx; i < limit; i++) {
      ...
      // --- Ajout des filtres d'activation ---
